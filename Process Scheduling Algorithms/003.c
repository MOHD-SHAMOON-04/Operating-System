// Program to implement shortest job first Non-preemptive scheduling algorithm and find the avg turnaround time, 
...
struct Process {
    ...
    int waitingTime;
    int responseTime;
    int finished; // flag to mark if process is completed
};
...
int main() {
    ...
    while (completed < n) {
        int idx = -1;
        int minBT = 100000; // very large value initially
